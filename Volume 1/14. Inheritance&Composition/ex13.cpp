/**
In SynthesizedFunctions.cpp, modify Chess to give it a default constructor,
copy-constructor, and assignment operator. Demonstrate that you’ve written these correctly.
**/
#include <iostream>
...
public:
    ...
    Chess& operator= (const Chess& right) { cout << "+++ Chess& operator=\n"; return *this; }
};
